...
% - Parameter   struct of Parameters
% ----------------------------------
function [Parameter] = NREL5MWDefaultParameter_FBNREL_NotchFilter(Parameter)
...
r_GB                                                    = 97;               % [-]
Omega_g_rated                           = rpm2radPs(12.1*r_GB);               % [rad/s]
...
%% Filter Generator Speed Federico
Parameter.Filter.LowPass.Enable         = 0;
f_3P = 3*Omega_g_rated/97;
Parameter.Filter.LowPass.f_cutoff       = f_3P/10;                              % [Hz]
% Parameter.Filter.LowPass.f_cutoff       = .5;                              % [Hz]

Parameter.Filter.DynamicNotchFilter1.Enable             = 1;                % [-]
Parameter.Filter.DynamicNotchFilter1.Gain        	    = 3/97;                % [-]
Parameter.Filter.DynamicNotchFilter1.RelativeBandwidth  = 0.3;              % [-]
Parameter.Filter.DynamicNotchFilter1.Depth              = 0.01;              % [-] 
Parameter.Filter.LowPassDynamicNotchFilter.f_cutoff     = 0.5/4;              % [Hz] 
